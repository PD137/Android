...
import com.example.saya.my.controller.adapter.InviteAdapter;
import com.example.saya.my.model.Model;
import com.example.saya.my.model.bean.InvitationInfo;
...
public class InviteActivity extends Activity {
    ...
    private InviteAdapter.OnInviteListener mOninviteListener = new InviteAdapter.OnInviteListener() {
        ...
        public void onAccept(final InvitationInfo invitationInfo) {
            //通知环信服务器，点击了接受按钮（访问服务器需要联网，开一个线程）
    ...
    protected void onDestroy() {
        super.onDestroy();//关闭广播，页面销毁的时候，否则内存泄漏
